...
from .views import dashboard, logout, register, login, studentActivities, loginTeacherView, teacherDashboard, assignPoints, manage_categories, create_announcement, manage_announcements
